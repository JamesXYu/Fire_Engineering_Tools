...
const YourCalculatorName = {
  ...
  // Optional: Restore state before rendering (for calculators with multiple modes/methods)
  // This is called before getHTML() to ensure correct state is shown
  restoreStateBeforeRender(windowId, savedValues) {
    // If your calculator has state that needs to be restored before rendering
    // (like method selection in BSmergeflow), implement this method
    // Example:
  ...
  attachEvents(windowId) {
    ...
    // Example: method button clicks, custom controls, etc.
    // For calculators with multiple methods, you may want to update figure/help windows:
    // this.updateHelpWindow(windowId);
    // this.updateFigureWindow(windowId);
  },
  
  // Optional: Update help window when method changes (for multi-method calculators)
  // updateHelpWindow(sourceWindowId) {
  //   // Find and update the help window content when method changes
  //   // See BSmergeflow.js for example implementation
  // },
  
  // Optional: Update figure window when method changes (for multi-method calculators)
  // updateFigureWindow(sourceWindowId) {
  //   // Find and update the figure window image when method changes
  //   // See BSmergeflow.js for example implementation
  // }
};
